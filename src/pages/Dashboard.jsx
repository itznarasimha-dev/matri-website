...
const TIER = {
  Platinum: { color: "#000080", bg: "#EEF1FF" },
...
function SectionHeader({ title, linkTo, linkLabel }) {
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
      <h2 style={{ fontFamily: "inherit", fontWeight: 700, fontSize: 20, color: "#1A1F36", margin: 0 }}>{title}</h2>
      {linkTo && (
        <Link to={linkTo} style={{ fontFamily: "inherit", fontSize: 13, color: "#000080", fontWeight: 600, textDecoration: "none" }}>
          {linkLabel || "View all →"}
        </Link>
      )}
    </div>
...
function Card({ title, children }) {
  return (
    <div style={{ background: "#fff", borderRadius: 16, padding: 18, boxShadow: "0 1px 12px rgba(0,0,128,0.07)", border: "1px solid #E8EBF5" }}>
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
        <h3 style={{ fontFamily: "inherit", fontWeight: 700, fontSize: 16, color: "#000080", margin: 0 }}>{title}</h3>
...
function StatChip({ icon, value, label, bg }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 10px", background: bg, borderRadius: 10 }}>
      ...
      <div>
        <div style={{ fontFamily: "inherit", fontWeight: 700, fontSize: 15, color: "#111827" }}>{value}</div>
        <div style={{ fontFamily: "inherit", fontSize: 10, color: "#6B7280" }}>{label}</div>
      </div>
    </div>
  );
}
    ...
    <div style={{ textAlign: "center", marginBottom: 16 }}>
      <div style={{ position: "relative", display: "inline-block" }}>
        ...
        <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          <span style={{ fontFamily: "inherit", fontWeight: 800, fontSize: 20, color: "#000080" }}>{pct}</span>
          <span style={{ fontFamily: "inherit", fontSize: 10, color: "#000080" }}>%</span>
        </div>
      </div>
      <div style={{ fontFamily: "inherit", fontSize: 12, color: "#6B7280", marginTop: 4 }}>Profile completion</div>
    </div>
  );
}
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ background: "linear-gradient(135deg,#000080,#1a1aad)", borderRadius: 18, padding: "22px 28px", color: "#fff", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 14, boxShadow: "0 8px 32px rgba(0,0,128,0.25)" }}>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            <Link to="/interests" style={{ padding: "9px 20px", borderRadius: 10, background: "#F8B500", color: "#1A1F36", fontFamily: "inherit", fontSize: 13, fontWeight: 700, textDecoration: "none", boxShadow: "0 4px 14px rgba(248,181,0,0.4)" }}>
              View Interests
            </Link>
            <Link to="/matches" style={{ padding: "9px 20px", borderRadius: 10, background: "rgba(255,255,255,0.15)", color: "#fff", fontFamily: "inherit", fontSize: 13, fontWeight: 600, textDecoration: "none", border: "1px solid rgba(255,255,255,0.3)" }}>
              Browse Matches
            </Link>
          </div>
        </div>
          ...
          <div style={{ display: "flex", gap: 14, overflowX: "auto", paddingBottom: 8 }}>
            {MATCH_CARDS.map((m, i) => (
              <div key={i} onClick={() => navigate(`/profile/${i + 1}`)}
                onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-6px)"; e.currentTarget.style.boxShadow = "0 12px 32px rgba(0,0,128,0.18)"; }}
                ...
                <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(transparent,rgba(26,31,54,0.88))", padding: "28px 12px 12px" }}>
                  <div style={{ fontFamily: "inherit", fontWeight: 600, fontSize: 13, color: "#fff" }}>{m.name}</div>
                  <div style={{ fontFamily: "inherit", fontSize: 11, color: "rgba(255,255,255,0.75)" }}>{m.city} · {m.age} yrs</div>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3" style={{ gap: 18 }}>
          ...
          <Card title="Profile Status">
            <div style={{ position: "relative", borderRadius: 12, overflow: "hidden", marginBottom: 16 }}>
              ...
              <Link to="/my-profile" style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "rgba(0,0,128,0.82)", color: "#fff", textAlign: "center", padding: 10, fontFamily: "inherit", fontSize: 12, fontWeight: 700, letterSpacing: "0.08em", textDecoration: "none" }}>
                EDIT PROFILE
              </Link>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8 }}>
              ...
              <StatChip icon={<Eye size={14} color="#000080" />}                  value={47} label="Views"    bg="#EEF1FF" />
          ...
          <Card title="Plan Details">
            ...
            <div style={{ background: "#F8F9FF", borderRadius: 12, padding: 14, marginBottom: 14, fontFamily: "inherit", fontSize: 13, color: "#374151", lineHeight: 1.9, border: "1px solid #E8EBF5" }}>
              ...
              {CHAT_LIST.map((c, i) => (
                <div key={i}
                  ...
                  <div style={{ minWidth: 0 }}>
                    <div style={{ fontFamily: "inherit", fontWeight: 600, fontSize: 13, color: "#111827", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{c.name}</div>
                    <div style={{ fontFamily: "inherit", fontSize: 11, color: "#9CA3AF", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{c.msg}</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            <h2 style={{ fontFamily: "inherit", fontWeight: 700, fontSize: 20, color: "#1A1F36", margin: 0 }}>Interest Requests</h2>
            {pendingCount > 0 && (
              <span style={{ fontFamily: "inherit", fontSize: 12, fontWeight: 700, background: "#FEF3C7", color: "#B45309", padding: "4px 14px", borderRadius: 20 }}>
                {pendingCount} New
              </span>
            )}
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {INTERESTS.map(req => {
              ...
              return (
                <div key={req.id}
                  onMouseEnter={e => e.currentTarget.style.boxShadow = "0 6px 24px rgba(0,0,128,0.10)"}
                  onMouseLeave={e => e.currentTarget.style.boxShadow = "0 1px 12px rgba(0,0,128,0.07)"}
                  style={{ background: "#fff", borderRadius: 16, padding: "12px 14px", boxShadow: "0 1px 12px rgba(0,0,128,0.07)", border: "1px solid #E8EBF5", display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap", transition: "box-shadow 0.2s", borderLeft: !isAcc && !isDec ? `4px solid ${tier.color}` : "4px solid #E5E7EB" }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontFamily: "inherit", fontWeight: 700, fontSize: 14, color: "#111827" }}>{req.name}</div>
                    <div style={{ fontFamily: "inherit", fontSize: 12, color: "#6B7280" }}>{req.city} · {req.age} yrs · {req.height} · {req.job}</div>
                    <div style={{ fontFamily: "inherit", fontSize: 11, color: "#9CA3AF", marginTop: 2 }}>Requested: {req.time}</div>
                  </div>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0 }}>
                    {isAcc ? (
                      <span style={{ fontFamily: "inherit", fontSize: 12, color: "#16A34A", fontWeight: 600, background: "#DCFCE7", padding: "6px 14px", borderRadius: 8 }}>✓ Accepted</span>
                    ) : isDec ? (
                      <span style={{ fontFamily: "inherit", fontSize: 12, color: "#DC2626", fontWeight: 600, background: "#FEE2E2", padding: "6px 14px", borderRadius: 8 }}>✗ Declined</span>
                    ) : (
                      <>
                        <button onClick={() => setAccepted(p => [...p, req.id])}
                          onMouseEnter={e => e.currentTarget.style.background = "#BBF7D0"}
                          onMouseLeave={e => e.currentTarget.style.background = "#DCFCE7"}
                          style={{ display: "flex", alignItems: "center", gap: 5, padding: "7px 14px", borderRadius: 8, background: "#DCFCE7", color: "#16A34A", border: "none", cursor: "pointer", fontFamily: "inherit", fontSize: 12, fontWeight: 600, transition: "background 0.15s" }}>
                          <CheckCircle size={13} /> Accept
                        </button>
                        <button onClick={() => setDeclined(p => [...p, req.id])}
                          onMouseEnter={e => e.currentTarget.style.background = "#FECACA"}
                          onMouseLeave={e => e.currentTarget.style.background = "#FEE2E2"}
                          style={{ display: "flex", alignItems: "center", gap: 5, padding: "7px 14px", borderRadius: 8, background: "#FEE2E2", color: "#DC2626", border: "none", cursor: "pointer", fontFamily: "inherit", fontSize: 12, fontWeight: 600, transition: "background 0.15s" }}>
                          <XCircle size={13} /> Decline
                        </button>
                      </>
                    )}
                    <Link to={`/profile/${req.id}`}
                      style={{ padding: "7px 14px", borderRadius: 8, background: "#EEF1FF", color: "#000080", fontFamily: "inherit", fontSize: 12, fontWeight: 600, textDecoration: "none" }}>
                      View Profile
                    </Link>
                  </div>
                </div>
        ...
        <section>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            <h2 style={{ fontFamily: "inherit", fontWeight: 700, fontSize: 20, color: "#1A1F36", margin: 0 }}>Profile Views</h2>
            <select style={{ fontFamily: "inherit", fontSize: 12, border: "1px solid #E8EBF5", borderRadius: 8, padding: "6px 12px", color: "#374151", background: "#fff", cursor: "pointer", outline: "none" }}>
          ...
          <div style={{ background: "#fff", borderRadius: 16, padding: 22, boxShadow: "0 1px 12px rgba(0,0,128,0.07)", border: "1px solid #E8EBF5" }}>
              ...
              {VIEW_DATA.map((v, i) => (
                <div key={i} style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
                  <div
                    ...
                    onMouseLeave={e => { e.currentTarget.style.background = "linear-gradient(180deg,#000080,#1a1aad)"; e.currentTarget.style.transform = "scaleX(1)"; }}
                    style={{ width: "100%", background: "linear-gradient(180deg,#000080,#1a1aad)", borderRadius: "4px 4px 0 0", height: `${(v / 50) * 120}px`, minHeight: 4, transition: "all 0.2s", cursor: "pointer" }}
                  />
                  <span style={{ fontFamily: "inherit", fontSize: 9, color: "#9CA3AF" }}>{MONTHS[i]}</span>
                </div>
              ))}
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: 16, fontFamily: "inherit", fontSize: 12, color: "#6B7280", borderTop: "1px solid #F3F4F6", paddingTop: 14 }}>
              <span>Total views: <strong style={{ color: "#000080" }}>347</strong></span>
              <span>This month: <strong style={{ color: "#000080" }}>50</strong></span>
