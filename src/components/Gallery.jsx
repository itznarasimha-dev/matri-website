...
const photos = [
  { src: 'https://images.unsplash.com/photo-1583939003579-730e3918a45a?w=600&q=80', span: 'md:col-span-2', label: 'Telugu Wedding' },
  ...
  { src: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600&q=80', span: 'md:col-span-2', label: 'Portrait' },
]
          ...
          {photos.map((p, i) => (
            <div key={i} className={`relative overflow-hidden rounded-xl group cursor-pointer ${p.span}`}>
              ...
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center"
                ...
                <span className="font-body text-white font-semibold text-sm tracking-wide uppercase">{p.label}</span>
              </div>
            </div>
          ))}
        </div>
