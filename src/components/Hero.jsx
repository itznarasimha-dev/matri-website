  ...
  return (
    <section style={{ position: 'relative', minHeight: '100vh', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        padding: 'clamp(100px,12vh,130px) 2rem clamp(60px,8vh,100px)',
        gap: 40,
      }}>

        {/* ── LEFT — headline + CTAs ── */}
        <div style={{ flex: '0 0 auto', width: 'clamp(300px, 46%, 560px)' }}>

          {/* Badge */}
          <div style={{ marginBottom: 24, animation: 'hup 0.5s ease both' }}>
            <span style={{
          ...
          <p style={{
            ...
            lineHeight: 1.8, marginBottom: 36, maxWidth: 420,
          ...
          <div style={{
            ...
            animation: 'hup 0.6s ease 0.26s both',
          }}>
          ...
          <div style={{
            ...
            animation: 'hup 0.6s ease 0.34s both',
            maxWidth: 420,
          }}>
            {STATS.map(({ icon: Icon, value, label }, i) => (
              <div key={i} style={{
                ...
                <Icon size={15} color="#E8836A" strokeWidth={2} />
                <div style={{ fontSize: '1.1rem', fontWeight: 800, color: '#fff', letterSpacing: '-0.02em', lineHeight: 1 }}>{value}</div>
                <div style={{ fontSize: 9.5, fontWeight: 600, color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.08em', textAlign: 'center' }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* ── RIGHT — search card ── */}
        <div style={{
          flex: '0 0 auto', width: 'clamp(220px, 30%, 320px)',
          marginLeft: 'auto',
          animation: 'hup 0.6s ease 0.2s both',
        }}>
          <div style={{
            ...
            <form onSubmit={handleSearch}>
              ...
              <div style={{ display: 'flex', gap: 6, marginBottom: 12 }}>
                {[['bride', 'Bride'], ['groom', 'Groom']].map(([val, lbl]) => (
                  <button key={val} type="button" onClick={() => setGender(val)} style={{
                    ...
                    border: gender === val ? '2px solid #fff' : '2px solid rgba(255,255,255,0.2)',
                    background: gender === val ? '#fff' : 'transparent',
                    color: gender === val ? '#000080' : 'rgba(255,255,255,0.6)',
              ...
              <button type="submit" style={{
                ...
                boxShadow: '0 6px 18px rgba(0,0,128,0.4)',
              }}
