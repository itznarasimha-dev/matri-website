...
function StatItem({ stat }) {
  ...
  return (
    <div className="text-center px-4 sm:px-8 py-2">
      ...
      <div style={{ fontFamily: 'Inter, system-ui, sans-serif', fontWeight: 500, fontSize: '0.7rem', color: 'rgba(255,255,255,0.7)', textTransform: 'uppercase', letterSpacing: '0.15em', marginTop: 6 }}>
        {stat.label}
      </div>
    </div>
  )
...
export default function StatsSection() {
  return (
    <section className="py-6 sm:py-8" style={{ background: '#2338B0' }}>
