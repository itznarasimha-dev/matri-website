...
function StatItem({ stat }) {
  ...
  return (
    <div className="text-center px-8">
      <div className="font-display text-5xl lg:text-6xl font-bold text-white leading-none mb-1">
        <span ref={ref}>0</span>
        <span>{stat.suffix}</span>
      </div>
      <div className="font-body text-xs uppercase tracking-[0.18em] font-semibold mt-2" style={{ color: 'rgba(255,255,255,0.7)' }}>
        {stat.label}
      </div>
    </div>
  )
...
export default function StatsSection() {
  return (
    <section className="py-10" style={{ background: '#2338B0' }}>
