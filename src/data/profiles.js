...
export const profileDetails = {
  1: { about: 'I am a software engineer at a top MNC in Hyderabad. I love classical dance, reading, and cooking. Looking for a well-educated, understanding partner who values family traditions.', family: { father: 'Retired Government Officer', mother: 'Homemaker', siblings: '1 brother (married)' }, expectations: "Looking for a well-educated, employed person with good family values. Age 26–32, height 5'7\" and above.", diet: 'Vegetarian', smoke: 'No', drink: 'No', hobbies: 'Classical Dance, Reading, Cooking' },
  2: { about: 'Data Scientist at a leading tech company in Bangalore. Passionate about cricket, travel, and good food. Family-oriented person looking for a loving life partner.', family: { father: 'Business', mother: 'Teacher', siblings: '1 sister (unmarried)' }, expectations: 'Looking for a well-educated, simple, family-oriented bride. Age 23–28.', diet: 'Non-Vegetarian', smoke: 'No', drink: 'Occasionally', hobbies: 'Cricket, Travelling, Photography' },
  3: { about: 'MBBS doctor working in Vijayawada. Passionate about healthcare and helping communities. I enjoy Carnatic music, painting, and cooking traditional dishes.', family: { father: 'Retired Teacher', mother: 'Doctor', siblings: '1 younger brother (student)' }, expectations: 'Looking for a kind, educated groom aged 26–32 who values both career and family.', diet: 'Vegetarian', smoke: 'No', drink: 'No', hobbies: 'Carnatic Music, Painting, Cooking' },
  4: { about: 'IT Manager based in the USA with 8+ years of experience. Traditional at heart with a modern outlook. Love travelling, cooking, and cricket.', family: { father: 'Business Owner', mother: 'Homemaker', siblings: '1 sister (married, USA)' }, expectations: 'Looking for an educated, career-driven bride comfortable with NRI lifestyle. Age 25–30.', diet: 'Non-Vegetarian', smoke: 'No', drink: 'Socially', hobbies: 'Travelling, Cricket, Cooking' },
  5: { about: 'Chartered Accountant in Visakhapatnam. Passionate about finance, fitness, and Indian culture. Family is my priority and I believe in a balanced life.', family: { father: 'Chartered Accountant', mother: 'Homemaker', siblings: 'Only child' }, expectations: 'Looking for a well-settled, respectful groom. Age 27–33, preferably a professional.', diet: 'Vegetarian', smoke: 'No', drink: 'No', hobbies: 'Yoga, Reading, Cooking' },
  6: { about: 'Entrepreneur running a successful startup in Hyderabad. I value innovation, family bonds, and Indian culture. Looking for a life partner who is ambitious and grounded.', family: { father: 'Businessman', mother: 'Teacher', siblings: '1 brother (engineer)' }, expectations: 'Looking for an educated, independent bride aged 24–29 who supports entrepreneurship.', diet: 'Non-Vegetarian', smoke: 'No', drink: 'Occasionally', hobbies: 'Startups, Travel, Photography' },
}
